...
Como o número é padronizado, da para comparar o sertão com o litoral, mesmo tendo climas bem diferentes.
...
- **SPI-3** (3 meses) seca de **curto prazo**
- **SPI-12** (12 meses) seca de **longo prazo**
...
2. **`calcular_spi(...)`** faz a conta do SPI usando o pacote `spei`
